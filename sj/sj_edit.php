...
<table class="table table-sm table-bordered mymargin5">
	...
	<tr>
		...
		<td align="left">
			<div class="d-inline-flex">
				<input type="text" name="kor" size="5" value="<?=$row["kor"]; ?>" 
					class="form-control form-control-sm" 
					onChange="cal_score();">
			</div>
		</td>
	...
	<tr>
		...
		<td align="left">
			<div class="d-inline-flex">
				<input type="text" name="eng" size="5"  value="<?=$row["eng"]; ?>" 
					class="form-control form-control-sm" 
						onChange="cal_score();">
			</div>
		</td>
	...
	<tr>
		...
		<td align="left">
			<div class="d-inline-flex">
				<input type="text" name="mat" size="5"  value="<?=$row["mat"]; ?>" 
					class="form-control form-control-sm" 
					onChange="cal_score();">
			</div>
		</td>
	...
	<tr>
		...
		<td align="left">&nbsp; 
			<div class="d-inline-flex">
				 <input type="text" name="hap" size="5"  value="<?=$row["hap"]; ?>"
	...
	<tr>
		...
		<td align="left">&nbsp; 
			<div class="d-inline-flex">
				 <input type="text" name="avg" size="5" value="<?=$row["avg"]; ?>"
